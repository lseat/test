...
let collect_binop (t:typ) (op:operator) (tl:typ) (tr:typ) : equation list =
                  match tl,tr with
                  |TString,TString -> [Eq(t,TString);Eq(tl,TString);Eq(tr,TString)]
                  |TInt,TInt ->  [Eq(t,TInt);Eq(tl,TInt);Eq(tr,TInt)]
 ...
 *)
let rec collect specs e =
    match e with
    |AVar (t,v) -> [Eq(t,(typeof e))]
    |AInt (t,i) -> [Eq(t,TInt)]
    |ABinOp(t,o,ae1,ae2) -> collect_binop t o (typeof ae1) (typeof ae2)
    |AFun(t,(v,t1),ae) ->  [Eq(t,TArrow(t1,(typeof ae)));] @ (collect specs ae)
    |AUnit t -> [Eq(t,TUnit)]
    |AString(t,s) -> [Eq(t,TString)]
    |APair(t,ae1,ae2) -> [Eq(t,TStar((typeof ae1),(typeof ae2)))] @ (collect specs ae1) @ (collect specs ae2)
    |ABool(t,b) -> [Eq(t,TBool)]
    |AIf(t,ae1,ae2,ae3) -> [Eq((typeof ae1),TBool);Eq((typeof ae2),TAlpha "a");
                           Eq((typeof ae3),TAlpha "a");Eq((typeof ae2),(typeof ae3));
                           Eq(t,TAlpha "a");]
    |ALet(t,(v,t1),ae1,ae2) -> (collect specs ae1) @ (collect specs ae2) @ [Eq(t,(typeof ae2)); Eq(t1,(typeof ae1))]
    |AApp(t,ae1,ae2) -> [Eq((typeof ae1),TArrow(TAlpha "a",TAlpha "b")) ; Eq((typeof ae2),TAlpha "a"); Eq(t,TAlpha "b")]
    |ALetRec(t,(v,t1),ae1,ae2) -> 
    |AVariant
